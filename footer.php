            ...
            <div class="reply__body">
                ...
                <form action="#">
                    <div class="reply__wrapper">
                      <?php echo do_shortcode('[contact-form-7 id="363aadf" title="Replay form name"]'); ?>
                        <!-- <div>
                    ...
                    <div class="reply__wrapper">
                      <?php echo do_shortcode('[contact-form-7 id="1495fce" title="Replay form email"]'); ?>
                      <?php echo do_shortcode('[contact-form-7 id="0de17e4" title="Replay form phone"]'); ?>
                    </div>
                    <?php echo do_shortcode('[contact-form-7 id="0f952be" title="Replay form question"]'); ?>
                    <button class="minibutton">Submit</button>
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:+797867834347"><?php the_field('phone_1', 15); ?></a>
                                    <a href="tel:+797867834358"><?php the_field('phone_2', 15); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php the_field('address', 15); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
